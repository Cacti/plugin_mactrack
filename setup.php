...
function mactrack_check_upgrade()
{
    ...
    if (!cacti_sizeof($old) || $current != $old['version']) {
        ...
        if (!cacti_sizeof($old) || 1 == $old['status'] || 4 == $old['status']) {
        ...
        if ('on' != read_config_option('mt_convert_readstrings', true)) {
            convert_readstrings();
        }
...
function mactrack_page_head()
{
    ...
    echo "<script type='text/javascript' src='".$config['url_path']."plugins/mactrack/mactrack.js'></script>\n";
    echo "<script type='text/javascript' src='".$config['url_path']."plugins/mactrack/mactrack_snmp.js'></script>\n";
    if (file_exists($config['base_path'].'/plugins/mactrack/themes/'.get_selected_theme().'/mactrack.css')) {
        echo "<link type='text/css' href='".$config['url_path'].'plugins/mactrack/themes/'.get_selected_theme()."/mactrack.css' rel='stylesheet'>\n";
    } else {
        echo "<link type='text/css' href='".$config['url_path']."plugins/mactrack/mactrack.css' rel='stylesheet'>\n";
    }
}
...
function mactrack_config_settings()
{
    ...
    $tabs_graphs += ['mactrack' => __('MacTrack Settings', 'mactrack')];

    $settings_user += [
        'mactrack' => [
            'default_mactrack_tab' => [
...
function mactrack_draw_navigation_text($nav)
{
    ...
    $nav['mactrack_devices.php:import'] = [
    ...
    $nav['mactrack_devices.php:actions'] = [
    ...
    $nav['mactrack_snmp.php:item_edit'] = [
        'title' => __('(Edit)', 'mactrack'),
        'mapping' => 'index.php:,mactrack_snmp.php:',
        'url' => '',
        'level' => '2',
    ...
    $nav['mactrack_device_types.php:edit'] = [
        'title' => __('(Edit)', 'mactrack'),
    ...
    $nav['mactrack_device_types.php:import'] = [
        'title' => __('(Import)', 'mactrack'),
        'mapping' => 'index.php:,mactrack_device_types.php:',
        'url' => '',
        'level' => '2',
    ...
    $nav['mactrack_device_types.php:actions'] = [
        'title' => __('Actions', 'mactrack'),
        'mapping' => 'index.php:,mactrack_device_types.php:',
        'url' => '',
        'level' => '2',
    ...
    $nav['mactrack_sites.php:actions'] = [
        'title' => __('Actions', 'mactrack'),
        'mapping' => 'index.php:,mactrack_sites.php:',
        'url' => '',
        'level' => '2',
    ...
    $nav['mactrack_macwatch.php:edit'] = [
        'title' => __('(Edit)', 'mactrack'),
    ...
    $nav['mactrack_macwatch.php:actions'] = [
        'title' => __('Actions', 'mactrack'),
        'mapping' => 'index.php:,mactrack_macwatch.php:',
        'url' => '',
        'level' => '2',
    ...
    $nav['mactrack_macauth.php:actions'] = [
        'title' => __('Actions', 'mactrack'),
        'mapping' => 'index.php:,mactrack_macauth.php:',
        'url' => '',
        'level' => '2',
    ...
    $nav['mactrack_view_macs.php:actions'] = [
        'title' => __('Actions', 'mactrack'),
    ...
    $nav['mactrack_view_interfaces.php:'] = [
    ...
    $nav['mactrack_utilities.php:mactrack_utilities_perform_db_maint'] = [
    ...
    $nav['mactrack_utilities.php:mactrack_utilities_purge_scanning_funcs'] = [
    ...
    $nav['mactrack_utilities.php:mactrack_utilities_recreate_aggregated_data'] = [
    ...
    $nav['mactrack_utilities.php:mactrack_proc_status'] = [
    ...
    $nav['mactrack_utilities.php:mactrack_refresh_oui_database'] = [
    ...
    $nav['mactrack_view_graphs.php:preview'] = [
        'title' => __('Mactrack Graph Viewer', 'mactrack'),
        'mapping' => '',
        'url' => 'mactrack_view_graphs.php',
        'level' => '0',
...
function mactrack_show_tab()
{
    ...
    if (api_user_realm_auth('mactrack_view_macs.php')) {
        if (substr_count($_SERVER['REQUEST_URI'], 'mactrack_view_')) {
            echo '<a href="'.html_escape($config['url_path'].'plugins/mactrack/mactrack_view_'.get_nfilter_request_var('report').'.php').'"><img src="'.$config['url_path'].'plugins/mactrack/images/tab_mactrack_down.png" alt="'.__('MacTrack', 'mactrack').'"></a>';
        } else {
            echo '<a href="'.html_escape($config['url_path'].'plugins/mactrack/mactrack_view_'.get_nfilter_request_var('report').'.php').'"><img src="'.$config['url_path'].'plugins/mactrack/images/tab_mactrack.png" alt="'.__('MacTrack', 'mactrack').'"></a>';
        }
    }
}
...
function mactrack_config_arrays()
{
    ...
    if (isset($_SESSION['mactrack_message']) && '' != $_SESSION['mactrack_message']) {
        $messages['mactrack_message'] = ['message' => $_SESSION['mactrack_message'], 'type' => 'info'];
...
function mactrack_config_form()
{
    ...
    $fields_mactrack_device_type_edit = [
        'spacer0' => [
            'method' => 'spacer',
        ...
        'serial_number_oid_type' => [
            ...
            'default' => 'get',
            'array' => ['get' => __('SNMP Get', 'mactrack'), 'walk' => __('SNMP Walk', 'mactrack')],
        ],
        'lowPort' => [
            'method' => 'textbox',
    ...
    // file: mactrack_snmp.php, action: item_edit
    $fields_mactrack_snmp_item_edit = $fields_mactrack_snmp_item + [
        'sequence' => [
            'method' => 'view',
