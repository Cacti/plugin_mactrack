...
function mactrack_database_upgrade () {
	...
	if (!mactrack_db_column_exists('mac_track_interfaces', 'sysUptime')) {
		...
		ADD COLUMN `ifInBroadcastPkts` int(10) unsigned NOT NULL default '0' AFTER `ifInBroadcastPkts`,
		ADD COLUMN `ifOutBroadcastPkts` int(10) unsigned NOT NULL default '0' AFTER `ifOutBroadcastPkts`,
		...
		ADD COLUMN `int_ifInMulticastPkts` int(10) unsigned NOT NULL default '0' AFTER `XXXXXXXX`,
		ADD COLUMN `int_ifOutMulticastPkts` int(10) unsigned NOT NULL default '0' AFTER `XXXXXXXX`,
		ADD COLUMN `int_ifInBroadcastPkts` int(10) unsigned NOT NULL default '0' AFTER `XXXXXXXX`,
		ADD COLUMN `int_ifOutBroadcastPkts` int(10) unsigned NOT NULL default '0' AFTER `XXXXXXXX`,");
...
function mactrack_config_settings () {
	...
	$tabs['mactrack'] = __('Device Tracking');
	...
	$settings['mactrack'] = array(
		...
		'mt_collection_timing' => array(
			'friendly_name' => __('Scanning Frequency'),
			'description' => __('Choose when to collect MAC and IP Addresses and Interface statistics from your network devices.'),
			'method' => 'drop_array',
			'default' => 'disabled',
			'array' => $mactrack_poller_frequencies,
			),
		'mt_processes' => array(
			'friendly_name' => __('Concurrent Processes'),
			'description' => __('Specify how many devices will be polled simultaneously until all devices have been polled.'),
			'default' => '7',
			'method' => 'textbox',
			'max_length' => '10',
			'size' => '4'
		...
		'mt_base_time' => array(
			'friendly_name' => __('Start Time for Data Collection'),
			'description' => __('When would you like the first data collection to take place.  All future data collection times will be based upon this start time.  A good example would be 12:00AM.'),
			'default' => '1:00am',
			'method' => 'textbox',
			'max_length' => '10',
			'size' => '8'
		...
		'mt_maint_time' => array(
			'friendly_name' => __('Database Maintenance Time'),
			'description' => __('When should old database records be removed from the database.  Please note that no access will be permitted to the port database while this action is taking place.'),
			'default' => '12:00am',
			'method' => 'textbox',
			'max_length' => '10',
			'size' => '8'
		...
		'mt_data_retention' => array(
			...
			'description' => __('How long should port MAC details be retained in the database.'),
			'method' => 'drop_array',
			'default' => '2weeks',
			'array' => $mactrack_data_retention,
			),
		'mt_ignorePorts_delim' => array(
			'friendly_name' => __('Switch Level Ignore Ports Delimiter'),
			'description' => __('What delimiter should MacTrack use when parsing the Ignore Ports string for each switch.'),
			'method' => 'drop_array',
			'default' => '-1',
			'array' => array('-1' => __('Auto Detect'), ':' => __('Colon [:]'), '|' => __('Pipe [|]'), ' ' => __('Space [ ]'))
			),
		'mt_mac_delim' => array(
			'friendly_name' => __('Mac Address Delimiter'),
			'description' => __('How should each octet of the MAC address be delimited.'),
			'method' => 'drop_array',
			'default' => ':',
			'array' => array(':' => __('Colon [:]'), '-' => __('Dash [-]'))
			),
		...
		'mt_interface_high' => array(
			'friendly_name' => __('Bandwidth Usage Threshold'),
			'description' => __('When reviewing network interface statistics, what bandwidth threshold do you want to view by default.'),
			'method' => 'drop_array',
			'default' => '70',
			'array' => array(
				'-1' => __('N/A'),
		...
		'mt_hdr_rdns' => array(
			'friendly_name' => __('DNS Settings'),
			'method' => 'spacer',
			),
		'mt_reverse_dns' => array(
			'friendly_name' => __('Perform Reverse DNS Name Resolution'),
			'description' => __('Should MacTrack perform reverse DNS lookup of the IP addresses associated with ports. CAUTION: If DNS is not properly setup, this will slow scan time significantly.'),
			'default' => '',
			'method' => 'checkbox'
			),
		...
		'mt_dns_timeout' => array(
			...
			'description' => __('Please enter the DNS timeout in milliseconds.  MacTrack uses a PHP based DNS resolver.'),
			'method' => 'textbox',
			'default' => '500',
			'max_length' => '10',
			'size' => '4'
		...
		'mt_dns_prime_interval' => array(
			'friendly_name' => __('DNS Prime Interval'),
			'description' => __('How often, in seconds do MacTrack scanning IP\'s need to be resolved to MAC addresses for DNS resolution.  Using a larger number when you have several thousand devices will increase performance.'),
			'method' => 'textbox',
			'default' => '120',
			'max_length' => '10',
			'size' => '4'
		...
		'mt_arpwatch' => array(
			'friendly_name' => __('Enable ArpWatch'),
			'description' => __('Should MacTrack also use ArpWatch data to supplement Mac to IP/DNS resolution?'),
			'default' => '',
			'method' => 'checkbox'
			),
		'mt_arpwatch_path' => array(
			'friendly_name' => __('ArpWatch Database Path'),
			'description' => __('The location of the ArpWatch Database file on the Cacti server.'),
			'method' => 'filepath',
			'default' => '',
			'max_length' => '255',
			'size' => '60'
		...
		'mt_snmp_communities' => array(
			'friendly_name' => __('Communities'),
			'description' => __('Fill in the list of available SNMP read strings to test for this device. Each read string must be separated by a colon \':\'.  These read strings will be tested sequentially if the primary read string is invalid.'),
			'method' => 'textbox',
...
function mactrack_draw_navigation_text ($nav) {
	$nav['mactrack_devices.php:'] = array('title' => __('MacTrack Devices'), 'mapping' => 'index.php:', 'url' => 'mactrack_devices.php', 'level' => '1');
	$nav['mactrack_devices.php:edit'] = array('title' => __('(Edit)'), 'mapping' => 'index.php:,mactrack_devices.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_devices.php:import'] = array('title' => __('(Import)'), 'mapping' => 'index.php:,mactrack_devices.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_devices.php:actions'] = array('title' => __('Actions'), 'mapping' => 'index.php:,mactrack_devices.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_snmp.php:'] = array('title' => __('MacTrack SNMP Options'), 'mapping' => 'index.php:', 'url' => 'mactrack_snmp.php', 'level' => '1');
	$nav['mactrack_snmp.php:actions'] = array('title' => __('Actions'), 'mapping' => 'index.php:,mactrack_snmp.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_snmp.php:edit'] = array('title' => __('(Edit)'), 'mapping' => 'index.php:,mactrack_snmp.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_snmp.php:item_edit'] = array('title' => __('(Edit)'), 'mapping' => 'index.php:,mactrack_snmp.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_device_types.php:'] = array('title' => __('MacTrack Device Types'), 'mapping' => 'index.php:', 'url' => 'mactrack_device_types.php', 'level' => '1');
	$nav['mactrack_device_types.php:edit'] = array('title' => __('(Edit)'), 'mapping' => 'index.php:,mactrack_device_types.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_device_types.php:import'] = array('title' => __('(Import)'), 'mapping' => 'index.php:,mactrack_device_types.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_device_types.php:actions'] = array('title' => __('Actions'), 'mapping' => 'index.php:,mactrack_device_types.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_sites.php:'] = array('title' => __('MacTrack Sites'), 'mapping' => 'index.php:', 'url' => 'mactrack_sites.php', 'level' => '1');
	$nav['mactrack_sites.php:edit'] = array('title' => __('(Edit)'), 'mapping' => 'index.php:,mactrack_sites.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_sites.php:actions'] = array('title' => __('Actions'), 'mapping' => 'index.php:,mactrack_sites.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_macwatch.php:'] = array('title' => __('Mac Address Tracking Utility'), 'mapping' => 'index.php:', 'url' => 'mactrack_macwatch.php', 'level' => '1');
	$nav['mactrack_macwatch.php:edit'] = array('title' => __('(Edit)'), 'mapping' => 'index.php:,mactrack_macwatch.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_macwatch.php:actions'] = array('title' => __('Actions'), 'mapping' => 'index.php:,mactrack_macwatch.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_macauth.php:'] = array('title' => __('Mac Address Authorization Utility'), 'mapping' => 'index.php:', 'url' => 'mactrack_macauth.php', 'level' => '1');
	$nav['mactrack_macauth.php:edit'] = array('title' => __('(Edit)'), 'mapping' => 'index.php:,mactrack_macauth.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_macauth.php:actions'] = array('title' => __('Actions'), 'mapping' => 'index.php:,mactrack_macauth.php:', 'url' => '', 'level' => '2');
	$nav['mactrack_vendormacs.php:'] = array('title' => __('MacTrack Vendor Macs'), 'mapping' => 'index.php:', 'url' => 'mactrack_vendormacs.php', 'level' => '1');
	$nav['mactrack_view_macs.php:'] = array('title' => __('MacTrack View Macs'), 'mapping' => '', 'url' => 'mactrack_view_macs.php', 'level' => '0');
	$nav['mactrack_view_macs.php:actions'] = array('title' => __('Actions'), 'mapping' => 'mactrack_view_macs.php:', 'url' => '', 'level' => '1');
	$nav['mactrack_view_arp.php:'] = array('title' => __('MacTrack IP Address Viewer'), 'mapping' => '', 'url' => 'mactrack_view_arp.php', 'level' => '0');
	$nav['mactrack_view_interfaces.php:'] = array('title' => __('MacTrack View Interfaces'), 'mapping' => '', 'url' => 'mactrack_view_interfaces.php', 'level' => '0');
	$nav['mactrack_view_sites.php:'] = array('title' => __('MacTrack View Sites'), 'mapping' => '', 'url' => 'mactrack_view_sites.php', 'level' => '0');
	$nav['mactrack_view_ips.php:'] = array('title' => __('MacTrack View IP Ranges'), 'mapping' => '', 'url' => 'mactrack_view_ips.php', 'level' => '0');
	$nav['mactrack_view_devices.php:'] = array('title' => __('MacTrack View Devices'), 'mapping' => '', 'url' => 'mactrack_view_devices.php', 'level' => '0');
	$nav['mactrack_utilities.php:'] = array('title' => __('Device Tracking Utilities'), 'mapping' => 'index.php:', 'url' => 'mactrack_utilities.php', 'level' => '1');
	$nav['mactrack_utilities.php:mactrack_utilities_perform_db_maint'] = array('title' => __('Perform Database Maintenance'), 'mapping' => 'index.php:,mactrack_utilities.php:', 'url' => 'mactrack_utilities.php', 'level' => '2');
	...
	$nav['mactrack_view_graphs.php:preview'] = array('title' => __('MacTrack Graph Viewer'), 'mapping' => '', 'url' => 'mactrack_view_graphs.php', 'level' => '0');
	return $nav;
}
...
function mactrack_config_arrays () {
	...
	$mactrack_search_types = array(
		...
		3 => __('Contains'),
		4 => __('Begins With'),
		5 => __('Does Not Contain'),
		6 => __('Does Not Begin With'),
		7 => __('Is Null'),
		8 => __('Is Not Null')
	);
	...
	$mactrack_update_policies = array(
		1 => __('None'),
		2 => __('Sync Cacti Device to MacTrack Device'),
		3 => __('Sync MacTrack Device to Cacti Device')
	);
	...
	foreach ($menu as $temp => $temp2 ) {
		...
		if ($temp == __('Management')) {
			$menu2[__('Device Tracking')]['plugins/mactrack/mactrack_sites.php']        = __('Sites');
			$menu2[__('Device Tracking')]['plugins/mactrack/mactrack_devices.php']      = __('Devices');
			$menu2[__('Device Tracking')]['plugins/mactrack/mactrack_snmp.php']         = __('SNMP Options');
			$menu2[__('Device Tracking')]['plugins/mactrack/mactrack_device_types.php'] = __('Device Types');
			$menu2[__('Device Tracking')]['plugins/mactrack/mactrack_vendormacs.php']   = __('Vendor Macs');
			$menu2[__('Device Tracking')]['plugins/mactrack/mactrack_utilities.php']    = __('Tracking Utilities');
			$menu2[__('Tracking Tools')]['plugins/mactrack/mactrack_macwatch.php']      = __('Mac Watch');
			$menu2[__('Tracking Tools')]['plugins/mactrack/mactrack_macauth.php']       = __('Mac Authorizations');
		}
	}
	$menu = $menu2;
}
...
function mactrack_config_form () {
	...
	'description' => array(
		...
		'description' => __('Give this device type a meaningful description.'),
		'value' => '|arg1:description|',
		'max_length' => '250'
		),
	'vendor' => array(
		'method' => 'textbox',
		'friendly_name' => __('Vendor'),
		'description' => __('Fill in the name for the vendor of this device type.'),
		'value' => '|arg1:vendor|',
		'max_length' => '250'
		),
	'device_type' => array(
		...
		'description' => __('Choose the type of device.'),
	...
	'scanning_function' => array(
		'method' => 'drop_sql',
		'friendly_name' => __('MAC Address Scanning Function'),
		'description' => __('The MacTrack scanning function to call in order to obtain and store port details.  The function name is all that is required.  The following four parameters are assumed and will always be appended: \'my_function($site, &$device, $lowport, $highport)\'.  There is no function required for a pure router.'),
	...
	'ip_scanning_function' => array(
		'method' => 'drop_sql',
		'friendly_name' => __('IP Address Scanning Function'),
		'description' => __('The MacTrack scanning function specific to Layer3 devices that track IP Addresses.'),
	...
	'serial_number_oid' => array(
		'method' => 'textbox',
		'friendly_name' => __('Serial Number Base OID'),
		'description' => __('The SNMP OID used to obtain this device types serial number to be stored in the MacTrack Asset Information table.'),
	...
	'serial_number_oid_type' => array(
		'method' => 'drop_array',
		'friendly_name' => __('Serial Number Collection Method'),
		'description' => __('How is the serial number collected for this OID.  If \'SNMP Walk\', we assume multiple serial numbers.  If \'Get\', it will be only one..'),
		'value' => '|arg1:serial_number_oid_method|',
		'default' => 'get',
		'array' => array('get' => __('SNMP Get'), 'walk' => __('SNMP Walk'))
		),
	'lowPort' => array(
		'method' => 'textbox',
		'friendly_name' => __('Low User Port Number'),
		'description' => __('Provide the low user port number on this switch.  Leave 0 to allow the system to calculate it.'),
		'value' => '|arg1:lowPort|',
	...
	'highPort' => array(
		'method' => 'textbox',
		'friendly_name' => __('High User Port Number'),
		'description' => __('Provide the low user port number on this switch.  Leave 0 to allow the system to calculate it.'),
		'value' => '|arg1:highPort|',
	...
	'spacer0' => array(
		'method' => 'spacer',
		'friendly_name' => __('General Device Settings')
		),
	'device_name' => array(
		'method' => 'textbox',
		'friendly_name' => __('Device Name'),
		'description' => __('Give this device a meaningful name.'),
	...
	'hostname' => array(
		...
		'description' => __('Fill in the fully qualified hostname for this device.'),
		'value' => '|arg1:hostname|',
		'max_length' => '250'
		),
	'host_id' => array(
		'friendly_name' => __('Related Cacti Host'),
		'description' => __('Given MacTrack Host is connected to this Cacti Host.'),
		#'method' => 'view',
		'method' => 'drop_sql',
		'value' => '|arg1:host_id|',
		'none_value' => __('None'),
	...
	'scan_type' => array(
		'method' => 'drop_array',
		'friendly_name' => __('Scan Type'),
		'description' => __('Choose the scan type you wish to perform on this device.'),
	...
	'site_id' => array(
		...
		'description' => __('Choose the site to associate with this device.'),
		'value' => '|arg1:site_id|',
		'none_value' => __('None'),
	...
	'notes' => array(
		'method' => 'textarea',
		'friendly_name' => __('Device Notes'),
		'description' => __('This field value is useful to save general information about a specific device.'),
		'class' => 'textAreaNotes',
		'textarea_rows' => '3',
		'textarea_cols' => '80',
		'value' => '|arg1:notes|',
	...
	'spacer1' => array(
		'method' => 'spacer',
		'friendly_name' => __('Switch/Hub, Switch/Router Settings')
		),
	'ignorePorts' => array(
		'method' => 'textarea',
		'friendly_name' => __('Ports to Ignore'),
		'description' => __('Provide a list of ports on a specific switch/hub whose MAC results should be ignored.  Ports such
	...
	'snmp_options' => array(
		'method' => 'drop_sql',
		'friendly_name' => __('SNMP Options'),
		'description' => __('Select a set of SNMP options to try.'),
	...
	'snmp_readstrings' => array(
		'method' => 'view',
		'friendly_name' => __('Read Strings'),
		'description' => __('<strong>DEPRECATED:</strong> SNMP community strings'),
		'value' => '|arg1:snmp_readstrings|',
		),
	'spacer3' => array(
		'method' => 'spacer',
		'friendly_name' => __('Specific SNMP Settings')
		),
	);
	...
	'spacer4' => array(
		'method' => 'spacer',
		'friendly_name' => __('Connectivity Options')
		),
	'term_type' => array(
		'method' => 'drop_array',
		'friendly_name' => __('Terminal Type'),
		'description' => __('Choose the terminal type that you use to connect to this device.'),
	...
	'user_name' => array(
		...
		'description' => __('The user name to be used for your custom authentication method.  Examples include SSH, RSH, HTML, etc.'),
	...
	'user_password' => array(
		...
		'description' => __('The password to be used for your custom authentication.'),
	...
	'private_key_path' => array(
		...
		'description' => __('The path to the private key used for SSH authentication.'),
	...
	'spacer0' => array(
		'method' => 'spacer',
		'friendly_name' => __('General Site Settings')
		),
	'site_name' => array(
		'method' => 'textbox',
		'friendly_name' => __('Site Name'),
		'description' => __('Please enter a reasonable name for this site.'),
	...
	'customer_contact' => array(
		'method' => 'textbox',
		'friendly_name' => __('Primary Customer Contact'),
		'description' => __('The principal customer contact name and number for this site.'),
	...
	'facilities_contact' => array(
		'method' => 'textbox',
		'friendly_name' => __('Facilities Contact'),
		'description' => __('Please principal facilities/security contact name and number for this site.'),
	...
	'spacer0' => array(
		'method' => 'spacer',
		'friendly_name' => __('General Mac Address Tracking Settings')
		),
	'mac_address' => array(
		'method' => 'textbox',
		'friendly_name' => __('MAC Address'),
		'description' => __('Please enter the MAC Address to be watched for.'),
	...
	'ticket_number' => array(
		'method' => 'textbox',
		'friendly_name' => __('Ticket Number'),
		'description' => __('Ticket number for cross referencing with your corporate help desk system(s).'),
	...
	'spacer0' => array(
		'method' => 'spacer',
		'friendly_name' => __('General Mac Address Authorization Settings')
		),
	'mac_address' => array(
		'method' => 'textbox',
		'friendly_name' => __('MAC Address Match'),
		'description' => __('Please enter the MAC Address or Mac Address Match string to be automatically authorized.  If you wish to authorize a group of MAC Addresses, you can use the wildcard character of \'%\' anywhere in the MAC Address.'),
		'value' => '|arg1:mac_address|',
		'default' => '',
		'max_length' => '40'
		),
	'description' => array(
		'method' => 'textarea',
		'friendly_name' => __('Reason'),
		'class' => 'textAreaNotes',
		'description' => __('Please add a reason for this entry.'),
		'value' => '|arg1:description|',
		'textarea_rows' => '4',
		'textarea_cols' => '80'
		),
