...
function mactrack_setup_table_new () {
	...
	if (!mactrack_db_table_exists("mac_track_interfaces")) {
		db_execute("CREATE TABLE `mac_track_interfaces` (
			...
			`int_ifInDiscards` int(10) unsigned NOT NULL default '0',
			`int_ifInErrors` int(10) unsigned NOT NULL default '0',
			`int_ifInUnknownProtos` int(10) unsigned NOT NULL default '0',
			`int_ifOutDiscards` int(10) unsigned NOT NULL default '0',
			`int_ifOutErrors` int(10) unsigned NOT NULL default '0',
