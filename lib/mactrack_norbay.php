...
/**
 * SNMP-scans a Bay Networks Accelar-series switch (modeled after the
 * Nortel/Bay Network 425-24T) for its port, VLAN, and MAC address
...
/**
 * SNMP-scans a Bay Networks switch (modeled after the Nortel/Bay
 * Network 425-24T) for its port, VLAN, and MAC address table data,
 * populating $device with counts and details. Registered in
