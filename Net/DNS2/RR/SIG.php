...
class Net_DNS2_RR_SIG extends Net_DNS2_RR
{
    ...
    protected function rrGet(Net_DNS2_Packet &$packet)
    {
        ...
        if ((0 == strlen($this->signature))
            ...
            $new_packet->header->arcount = cacti_sizeof($new_packet->additional);
            ...
            switch ($this->algorithm) {
                ...
                case Net_DNS2_Lookups::DNSSEC_ALGORITHM_RSASHA256:
                    if (true == version_compare(PHP_VERSION, '5.4.8', '<')) {
            ...
            // sign the data
            //
            if (false == openssl_sign($sigdata, $this->signature, $this->private_key->instance, $algorithm)) {
                throw new Net_DNS2_Exception(
