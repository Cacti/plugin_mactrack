...
class Net_DNS2_RR_AMTRELAY extends Net_DNS2_RR
{
    ...
    protected function rrToString()
    {
        ...
        //
        if ((self::AMTRELAY_TYPE_NONE == $this->relay_type) || (self::AMTRELAY_TYPE_DOMAIN == $this->relay_type)) {
            $out .= '.';
        }
    ...
    protected function rrFromString(array $rdata)
    {
        ...
        switch ($this->relay_type) {
            ...
            case self::AMTRELAY_TYPE_IPV4:
                if (false == Net_DNS2::isIPv4($this->relay)) {
                    return false;
                }
            ...
            case self::AMTRELAY_TYPE_IPV6:
                if (false == Net_DNS2::isIPv6($this->relay)) {
                    return false;
                }

                break;

            case self::AMTRELAY_TYPE_DOMAIN:; // do nothing
    ...
    protected function rrGet(Net_DNS2_Packet &$packet)
    {
        ...
        //
        switch ($this->relay_type) {
            case self::AMTRELAY_TYPE_NONE:; // add nothing
