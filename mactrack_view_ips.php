...
function mactrack_view_ip_ranges()
{
    ...
    if (cacti_sizeof($ip_ranges)) {
        ...
        echo '<tr><td colspan="'.$columns.'"><em>'.__('No Mactrack Site IP Ranges Found', 'mactrack').'</em></td></tr>';
    }
...
function mactrack_ips_filter()
{
    ...
    ?>
					...
					<td>
						<span>
							<button type='submit' id='export' class='ui-button ui-corner-all ui-widget ui-state-active'><?php echo __esc('Export', 'mactrack'); ?></button>
